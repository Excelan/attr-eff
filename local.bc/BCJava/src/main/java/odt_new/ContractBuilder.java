...
public class ContractBuilder {
    public static void main(String[] args) {
        try {
            ...
            ContractInfo.ApplicationRow row1 = new ContractInfo.ApplicationRow();
            row1.text = "В данном приложении прилагаются блок-схемы";

            ContractInfo.ApplicationRow.MediaRow subrow1=new ContractInfo.ApplicationRow.MediaRow();
            subrow1.urii=("file:///~odf.png");
            subrow1.picturename="Graphic1";
            row1.mediarows.add(subrow1);

            ContractInfo.ApplicationRow.MediaRow subrow2=new ContractInfo.ApplicationRow.MediaRow();
            subrow2.urii=("file:///~odf.png");
            subrow2.picturename="Graphic2";
            row1.mediarows.add(subrow2);

            ContractInfo.ApplicationRow.MediaRow subrow3=new ContractInfo.ApplicationRow.MediaRow();
            ...
            ContractInfo.ApplicationRow row2 = new ContractInfo.ApplicationRow();
            ...
            Paragraph paragraph11 = document.addParagraph("на техническое обслуживание и ремонт оборудования");
            ...
            for (int i = 0; i < info.tablerows.size(); i++) {
                ...
                document.save("/home/anton/printForms/contracts/contractTME.odt");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
