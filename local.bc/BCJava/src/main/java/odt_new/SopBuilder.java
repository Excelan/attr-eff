...
public class SopBuilder {
    public static void main(String[] args) {
        try {
            ...
            String effectivdate=info.effectivedate;
            ...
            SopInfo.StructPoryadokParagraph block1 = new SopInfo.StructPoryadokParagraph();
            ...
            SopInfo.StructPoryadokParagraph block2 = new SopInfo.StructPoryadokParagraph();
            ...
            Paragraph paragraph01 = document.addParagraph("Дата введения в действие: "+effectivdate);
            Paragraph paragraph02 = document.addParagraph("Конечная дата действия: "+enddate);
            ...
            document.save("/home/anton/printForms/sop.odt");
