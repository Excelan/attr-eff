 ...
 */
public class TechTaskServiceBuilder {
    public static void main(String[] args) {
        try {
            ...
            */
            TechTaskServiceInfo serviceInfo =new TechTaskServiceInfo();
            String docymentname =serviceInfo.docname;
            String workstype=serviceInfo.workstype;
            String group=serviceInfo.group;
            String brunch=serviceInfo.brunch;
            String wordescription=serviceInfo.workdescription;
            String datebegin=serviceInfo.datebegin;
            String datebeend=serviceInfo.datebeend;
            String docspermitted=serviceInfo.docspermitted;
            String audit=serviceInfo.audit;
            String personrecieve=serviceInfo.personrecieve;
            String сonperson=serviceInfo.conperson;
            String changes =serviceInfo.changes;
            String projectdocname=serviceInfo.projectdocname;
            String projectdoceed=serviceInfo.projectdoceed;
            String deliveryconditions=serviceInfo.deliveryconditions;
            String prioritys=serviceInfo.prioritys;
            ...
            String attachment=serviceInfo.attachment;
           ...
           // table.getCellByPosition(0, 4).setStringValue("");
            ...
            cell41.setStringValue("7.Требуемая разрешительная документация");
            ...
            cell51.setStringValue("8.Необходимость в проведении предварительного аудита");
            Cell cell52= table5.getCellByPosition(0, 1);
            cell52.setStringValue("9.Лицо, ответственное за осуществление технадзора со стороны заказчика");
            Cell cell53 = table5.getCellByPosition(0, 2);
            cell53.setStringValue("10.Контактное лицо для ответа ответа на технические вопросы");
            Cell cell54= table5.getCellByPosition(0, 3);
            cell54.setStringValue("11. Необходимость в разработке/ внесении изменений в проектную документацию");
            ...
            cell69.setStringValue("16. Приложения ");
            ...
            cell71.setStringValue("17.Участники тендера");
            ...
            document.save("/home/anton/printForms/techzadanservice.odt");
