...
public class CreateDraftIn implements StageIn {
    ...
    {
        System.out.println("!!! > CLAIM IN CREATE_DRAFT");
        try {
            ...
            URN subjectURN = Document.createDraftForProcessBy(new URN(Prototype.fromString(subjectPrototype)), mpe.getUPN(), mpe.getInitiator());
