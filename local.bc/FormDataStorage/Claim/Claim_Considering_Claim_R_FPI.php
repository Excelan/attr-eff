...
$GLOBALS['SAVE_Claim_Considering_Claim_R_FPI'] = function ($d, $ticketurn) {
...
$GLOBALS['LOAD_Claim_Decision_Claim_R_FPI'] = $GLOBALS['LOAD_Claim_Considering_Claim_R_FPI'] = function ($urn) {
    $m = new Message();
    $m->action = "load";
    $m->urn = $urn;
    $loaded = $m->deliver();
...
$GLOBALS['LOAD_Claim_DoingTask_Claim_R_FPI'] = function ($urn) {
    $m = new Message();
    $m->action = "load";
    $m->urn = $urn;
    $loaded = $m->deliver();
