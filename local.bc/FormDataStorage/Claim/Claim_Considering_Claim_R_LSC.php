...
$GLOBALS['SAVE_Claim_Considering_Claim_R_LSC'] = function ($d, $ticketurn)
{
...
$GLOBALS['LOAD_Claim_Decision_Claim_R_LSC'] = $GLOBALS['LOAD_Claim_Considering_Claim_R_LSC'] = function ($urn)
{
    $m = new Message();
    $m->action = "load";
    $m->urn = $urn;
...
$GLOBALS['LOAD_Claim_DoingTask_Claim_R_LSC'] = function ($urn)
{
    $m = new Message();
    $m->action = "load";
    $m->urn = $urn;
