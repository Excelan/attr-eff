...
$GLOBALS['LOAD_Contract_Editing_Contract_LWP']=$GLOBALS['LOAD_Contract_Considering_Contract_LWP']=$GLOBALS['LOAD_Contract_Decision_Contract_LWP']=$GLOBALS['LOAD_Contract_Approving_Contract_LWP'] = function ($urn)
{
  Log::info("LOAD_Contract_Editing_Contract_LWP", 'uniload');
...
$GLOBALS['SAVE_Contract_Editing_Contract_LWP'] = $GLOBALS['SAVE_Contract_Considering_Contract_LWP']=$GLOBALS['SAVE_Contract_Decision_Contract_LWP']=$GLOBALS['SAVE_Contract_Approving_Contract_LWP'] =function ($d)
{
  Log::info("XX SAVE_Contract_Editing_Contract_LWP", 'unisave');
