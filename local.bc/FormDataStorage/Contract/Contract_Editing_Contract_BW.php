...
$GLOBALS['LOAD_Contract_Editing_Contract_BW']=$GLOBALS['LOAD_Contract_Considering_Contract_BW']=$GLOBALS['LOAD_Contract_Decision_Contract_BW']=$GLOBALS['LOAD_Contract_Approving_Contract_BW'] = function ($urn)
{
  Log::info("LOAD_Contract_Editing_Contract_BW", 'uniload');
...
$GLOBALS['SAVE_Contract_Editing_Contract_BW'] = $GLOBALS['SAVE_Contract_Considering_Contract_BW']=$GLOBALS['SAVE_Contract_Decision_Contract_BW']=$GLOBALS['SAVE_Contract_Approving_Contract_BW'] =function ($d)
{
  Log::info("XX SAVE_Contract_Editing_Contract_BW", 'unisave');
