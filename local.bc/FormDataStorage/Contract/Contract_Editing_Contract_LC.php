...
$GLOBALS['LOAD_Contract_Editing_Contract_LC']=$GLOBALS['LOAD_Contract_Considering_Contract_LC']=$GLOBALS['LOAD_Contract_Decision_Contract_LC']=$GLOBALS['LOAD_Contract_Approving_Contract_LC'] = function ($urn)
{
  Log::info("LOAD_Contract_Editing_Contract_LC", 'uniload');
...
$GLOBALS['SAVE_Contract_Editing_Contract_LC'] = $GLOBALS['SAVE_Contract_Considering_Contract_LC']=$GLOBALS['SAVE_Contract_Decision_Contract_LC']=$GLOBALS['SAVE_Contract_Approving_Contract_LC'] =function ($d)
{
  Log::info("XX SAVE_Contract_Editing_Contract_LC", 'unisave');
