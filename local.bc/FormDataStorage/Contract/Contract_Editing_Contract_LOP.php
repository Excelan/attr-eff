...
$GLOBALS['LOAD_Contract_Editing_Contract_LOP']=$GLOBALS['LOAD_Contract_Considering_Contract_LOP']=$GLOBALS['LOAD_Contract_Decision_Contract_LOP']=$GLOBALS['LOAD_Contract_Approving_Contract_LOP'] = function ($urn)
{
  Log::info("LOAD_Contract_Editing_Contract_LOP", 'uniload');
...
$GLOBALS['SAVE_Contract_Editing_Contract_LOP'] = $GLOBALS['SAVE_Contract_Considering_Contract_LOP']=$GLOBALS['SAVE_Contract_Decision_Contract_LOP']=$GLOBALS['SAVE_Contract_Approving_Contract_LOP'] =function ($d)
{
  Log::info("XX SAVE_Contract_Editing_Contract_LOP", 'unisave');
