...
$GLOBALS['LOAD_Contract_Editing_Contract_RSS']=$GLOBALS['LOAD_Contract_Considering_Contract_RSS']=$GLOBALS['LOAD_Contract_Decision_Contract_RSS']=$GLOBALS['LOAD_Contract_Approving_Contract_RSS'] = function ($urn)
{
  Log::info("LOAD_Contract_Editing_Contract_RSS", 'uniload');
...
$GLOBALS['SAVE_Contract_Editing_Contract_RSS'] = $GLOBALS['SAVE_Contract_Considering_Contract_RSS']=$GLOBALS['SAVE_Contract_Decision_Contract_RSS']=$GLOBALS['SAVE_Contract_Approving_Contract_RSS'] =function ($d)
{
  Log::info("XX SAVE_Contract_Editing_Contract_RSS", 'unisave');
