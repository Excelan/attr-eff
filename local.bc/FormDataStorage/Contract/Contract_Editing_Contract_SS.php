...
$GLOBALS['LOAD_Contract_Editing_Contract_SS']=$GLOBALS['LOAD_Contract_Considering_Contract_SS']=$GLOBALS['LOAD_Contract_Decision_Contract_SS']=$GLOBALS['LOAD_Contract_Approving_Contract_SS'] = function ($urn)
{
  Log::info("LOAD_Contract_Editing_Contract_SS", 'uniload');
...
$GLOBALS['SAVE_Contract_Editing_Contract_SS'] = $GLOBALS['SAVE_Contract_Considering_Contract_SS']=$GLOBALS['SAVE_Contract_Decision_Contract_SS']=$GLOBALS['SAVE_Contract_Approving_Contract_SS'] =function ($d)
{
  Log::info("XX SAVE_Contract_Editing_Contract_SS", 'unisave');
  Log::info($d, 'unisave');
