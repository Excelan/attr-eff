...
$GLOBALS['LOAD_Contract_Editing_Contract_TMC']=$GLOBALS['LOAD_Contract_Considering_Contract_TMC']=$GLOBALS['LOAD_Contract_Decision_Contract_TMC']=$GLOBALS['LOAD_Contract_Approving_Contract_TMC'] = function ($urn)
{
  Log::info("LOAD_Contract_Editing_Contract_TMC", 'uniload');
...
$GLOBALS['SAVE_Contract_Editing_Contract_TMC'] = $GLOBALS['SAVE_Contract_Considering_Contract_TMC']=$GLOBALS['SAVE_Contract_Decision_Contract_TMC']=$GLOBALS['SAVE_Contract_Approving_Contract_TMC'] =function ($d)
{
  Log::info("XX SAVE_Contract_Editing_Contract_TMC", 'unisave');
  Log::info($d, 'unisave');
  Log::info($d->notifyusercompany, 'unisave');
  ...
  //  Log::info($d->contractapplication, 'unisave');
