...
/*$GLOBALS['LOAD_Staffdoc_Editing_Staffdoc_OR'] = function ($urn)
{
...
$GLOBALS['SAVE_Staffdoc_Editing_Staffdoc_OR'] = function ($d)
{
    Log::info("SAVE_Staffdoc_Editing_Staffdoc_OR", 'unisave');
