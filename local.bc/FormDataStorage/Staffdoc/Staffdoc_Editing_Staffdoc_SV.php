...
/*$GLOBALS['LOAD_Staffdoc_Editing_Staffdoc_SV'] = function ($urn)
{
...
$GLOBALS['SAVE_Staffdoc_Editing_Staffdoc_SV'] = function ($d)
{
    Log::info("SAVE_Staffdoc_Editing_Staffdoc_SV+-", 'unisave');
