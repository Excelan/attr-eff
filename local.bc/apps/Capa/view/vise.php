...
//Люди которым позволено визировать
$approvePeople = array();
                                                    ...
                                                    <div class="infotitle vam">
                                                        ...
                                                        <?if($allowed){?>
                                                            <div class="labelinline FR">
                                                                ...
                                                                <label for="<?=$solution->urn?>">Рекомендовать</label>
                                                            </div>
                                                        <?}?>
                                                    </div>
                                                    <div class="infobody">
        ...
        <div class="box" style="margin: 0">
            ...
            <div class="innerbox">
                ...
                <div class="buttonblock">
                    ...
                    <div class="lbutoon" style="float: none">
                        <input type="submit" class="tbut" value="ВЫЙТИ">
                    </div>

                    <button class="IBLK w300 GBTN FR" id="send_approve_btn">Визировать</button>
                    <p class="w200 subbtext">вернуть документ на стадию создания</p>
                </div>-->
                ...
                <div class="buttons">
                    ...
                    <p class="itext">
                        <a id="cancelform" data-param="cancel" href="#" class="rin">Отклонить</a>
                    </p>
                    <a id="visingform" data-param="vising" href="#" class="gin">Визировать</a>
                </div>
                <div class="cause">
                    <textarea placeholder="Укажите причину отмены" id="cancelformtext"></textarea>
                </div>
...
<input type="hidden" value="<?=$this->managementrole->urn?>" id="curentUserPost"/>

<?if($allowed){?>
    <script type="text/javascript" src="/js/vising.js?101"></script>
    <script>
