...
//class AnyTaxonomyRelatedAnyStructure extends AnyContentRelatedAnyTaxonomy {}
class AnyTaxonomyRelatedAnyStructure extends FormWidget
{
	...
	{	
		try
		{
			...
			else
			{
				...
				$jsuri = '/goldcut/js/formwidgets/AnyContentRelatedAnyTaxonomy.js';
