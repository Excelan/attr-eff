...
%\usepackage[hmargin=2cm,top=2cm,headheight=65pt,footskip=65pt]{geometry}
\usepackage[a4paper, portrait, margin=1in, hmargin=2cm, top=3.5cm, bottom=4cm, headheight=3cm, footskip=2.5cm]{geometry} % формат бумаги и отступы showframe
