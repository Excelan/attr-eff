...
\textbf{№ PR (picking request)}      &  {{pickingrequest}}\\  [2ex]
\textbf{Планируемая дата отгрузки}      &  {{planshipmentdate}}\\  [2ex]
\textbf{Получатель груза} &  {{cargoreceiver}} \\  [2ex]
\textbf{Основание отгрузки} &  {{reasonshipping}} \\  [2ex]
