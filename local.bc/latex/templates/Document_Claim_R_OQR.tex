...
\center{\textbf{ЗАЯВКА}}
\vspace{1mm}
\center{\textbf{НА ПОКУПКУ / ПОЛУЧЕНИЕ РАСХОДНЫХ МАТЕРИАЛОВ}}
...
\textbf{Ф.И.О получателя}      &  {{/purchaseorder}}  {{nameofemployee}} {{#purchaseorder}}   \\  [2ex]
\textbf{Название расходного материала/НМА}          &  {{purchasename}}\\  [2ex]
\textbf{Требуемое количество расходного материала/НМА} &  {{purchasequantity}} \\  [2ex]
\end{tabu}
