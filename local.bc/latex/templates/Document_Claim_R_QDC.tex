...
\center{\textbf{ЗАЯВКА}}
\vspace{1mm}
\center{\textbf{НА ЗАПУСК ПРОЦЕССА УПРАВЛЕНИЯ ИЗМЕНЕНИЯМИ (САРА)}}
...
\textbf{Исходная ситуация} & {{initialsituation}} \\  [2ex]
\textbf{Описание изменений} &   {{changesdescription}}  \\ [2ex]
\textbf{Ожидаемый результат} &   {{expectedresult}}  \\ [2ex]
\textbf{Ссылка на документ} &   {{link}}  \\ [2ex]
