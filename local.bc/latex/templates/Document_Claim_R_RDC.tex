...
\center{\textbf{ЗАЯВКА}}
\vspace{1mm}
\center{\textbf{НА СОЗДАНИЕ НОВОГО РЕГЛАМЕНТИРУЕЩОГО ДОКУМЕНТА}}
...
\textbf{Описание необходимости}      &  {{/DirectoryBusinessProcessItem}} {{title}} {{#DirectoryBusinessProcessItem}}   \\  [2ex]
\textbf{Основной регламентирующий документ}      &  {{regulatingdocument}}    \\  [2ex]
\textbf{Название документа}      &  {{ocname}}    \\  [2ex]
\textbf{Масштаб применения}      &  {{scaleapplication}}    \\  [2ex]
