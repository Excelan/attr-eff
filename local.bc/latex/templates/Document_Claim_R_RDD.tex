...
\center{\textbf{ЗАЯВКА}}
\vspace{1mm}
\center{\textbf{НА ВЫДАЧУ/ИЗЪЯТИЕ КОПИЙ ДОКУМЕНТОВw}}
...
\textbf{Выдача/изъятие копии по документу} & {{/DocumentCopyControled}} {{title}}  {{#DocumentCopyControled}}  \\  [2ex]
\textbf{ФИО кому выдавать/изымать} & {{/purchaseuser}} {{nameofemployee}}   {{#purchaseuser}}  \\  [2ex]
