...
\center{\textbf{ЗАЯВКА}}
\vspace{1mm}
\center{\textbf{НА ВНЕСЕНИЕ ИЗМЕНЕНИЙ В РЕГЛАМЕНТИРУЮЩИЙ ДОКУМЕНТ}}
...
\textbf{Документ для изменения}      &  {{regulatingdocument}}   \\  [2ex]
\textbf{Причина изменений}      &  {{reasonforchange}}   \\  [2ex]
