...
\center{\textbf{ЗАЯВКА}}
\vspace{1mm}
\center{\textbf{НА ВЫДАЧУ/УДАЛЕНИЕ ДОСТУПА К ИНТЕРНЕТ РЕСУРСАМ}}
...
\textbf{Описание необходимости}      &  {{/internetuser}} {{nameofemployee}} {{#internetuser}}   \\  [2ex]
\textbf{Список WEB-ресурсов для доступа}      &  {{link}}\\  [2ex]
