...
\center{\textbf{ЗАЯВКА}}
\vspace{1mm}
\center{\textbf{НА ПОКУПКУ/ПОЛУЧЕНИЕ ЭТИКЕТОК ДЛЯ ПЕЧАТИ LPN}}
...
\textbf{Получатель}      &  {{#recipient}} {{nameofemployee}} {{/recipient}} \\  [2ex]
\textbf{Описание необходимости}      &  {{descriptionneed}} \\  [2ex]
\textbf{Название расходного материала}      &  {{permissionscurrent}} \\  [2ex]
\textbf{Требуемое количество расходного материала/НМА}      &  {{materialquantity}} \\  [2ex]
