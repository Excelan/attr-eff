...
\center{\textbf{ЗАЯВКА}}
\vspace{1mm}
\center{\textbf{НА ИЗМЕНЕНИЕ В ПАРАМЕТРАХ ДОСТУПА СКД }}
...
\textbf{Текущие права доступа}      &  {{permissionscurrent}}\\  [2ex]
\textbf{Описание новых прав доступа}      &  {{permissionnewsdescription}}\\  [2ex]
